...
> Windows 11 по умолчанию имеет многие вещи, которые необходимо включать или устанавливать на Windows 10, поэтому если у вас 11 версия, то не задумываясь о требованиях можете выбирать "элегантный вариант" и наслаждаться жизнью.
...
Активируйте Hyper-V, установите WSL 2, выберите из доступных понравившейся дистрибутив Linux и наслаждайтесь простым и быстрым доступом прямо из вашей "домашней" системы. Я предпочитаю Ubuntu.
